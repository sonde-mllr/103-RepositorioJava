...
public class TestExpediente {
	...
	public static void main(String[] args) {
		...
		Nota n1 = new Nota(a1,2014, TipoConvocatoria.PRIMERA,1.3,false);
		System.out.println("Nota 1" + n1);
		Nota n2 = new Nota(a1,2014, TipoConvocatoria.SEGUNDA,2.3,false);
		System.out.println("Nota 2" + n2);
		Nota n3 = new Nota(a1,2014, TipoConvocatoria.TERCERA,3.3,false);
		...
		Nota n4 = new Nota(a1,2014, TipoConvocatoria.PRIMERA,5.3,false);
		e1.nuevaNota(n4);
