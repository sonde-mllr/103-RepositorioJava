...
public class TestVinotecaStream {
	...
	public static void main(String[] args) {
		...
		VinotecaStream vinos1 = new VinotecaStream(lista_vinos);
		VinotecaStream vinos2 = FactoriaVinos.leerVinoteca("data/wine_reviews.csv");
	...
	public static void testConstructor(Collection<Vino> coleccion_vinos) {
		...
		try {
			VinotecaStream vinos = new VinotecaStream(coleccion_vinos);
	...
	public static void testCalcularNumeroVinosPais(VinotecaStream vinos, String pais) {
	...
	public static void testObtenerVinosRangoPuntos(VinotecaStream vinos, Integer inf, Integer sup) {
	...
	public static void testCalcularNumeroVinosDePaisConPuntuacionSuperior (VinotecaStream vinos, String pais, Integer umbralPuntuacion) {
		...
		try {
			System.out.println(String.format("\tHay %d  vinos del pais %s con puntuación superior a %d: ",
					                 vinos.calcularNumeroVinosDePaisConPuntuacion(pais, umbralPuntuacion), 
	...
	private static void testObtenerVinosBaratos(VinotecaStream vinos, Double precio) {
	...
	private static void testExisteVinoDeUvaEnRegion(VinotecaStream vinos, String uva, String region) {
	...
	public static void testCalcularUvasDeRegion(VinotecaStream vinos, String region) {
		System.out.println("\nTEST de calcularUvasDeRegion");
		try {
			Set<String> uvas = vinos.calcuarUvasDeRegion(region);
	...
	private static void testCalcularTotalPuntosVinosDeRegion(VinotecaStream vinos, String region) {
	...
	private static void testCalcularMediaPuntosVinosDeUva(VinotecaStream vinos, String uva) {
	...
	public static void testObtenerVinoMejorPuntuado(VinotecaStream vinos) {
	...
	private static void testObtenerVinoMejorPuntuadoDePais(VinotecaStream vinos, String pais) {
	...
	private static void testObtenerNVinosRegionOrdenadosPrecio(VinotecaStream vinos, String region, Integer n) {
	...
	public static void testCalcularVinosPorPais(VinotecaStream vinos) {
	...
	public static void testAgruparUvasPorPais(VinotecaStream vinos) {
	...
	public static void testCalcularCalidadPrecioPorRegionMayorDe(VinotecaStream vinos, Double umbral) {
	...
	public static void testCalcularVinoMasCaroPorPais(VinotecaStream vinos) {
	...
	public static void testCalcularNMejoresVinosPorPais(VinotecaStream vinos, Integer n) {
	...
	public static void testCalcularRegionConMejoresVinos(VinotecaStream vinos, Double umbral) {
